...
import './index.css'; // Make sure Tailwind's index.css is imported

// IMPORTANT: This URL will be updated for deployment later
// For local testing, ensure your backend is running on port 5000
